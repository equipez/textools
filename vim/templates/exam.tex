...
% Show ``Page xx of yy'' at the foot.
...
\fancypagestyle{plain}{\renewcommand{\headrulewidth}{0pt}\fancyhf{}\fancyfoot[C]{\footnotesize Page \thepage\ of \pageref{LastPage}}}


% Exam solution
\def\solution{0}
%\def\solution{1}
\if\solution1\newcommand{\sol}[1]{~\\~\textbf{Solution.~}#1~\\~}\else\newcommand{\sol}[1]{}\fi
