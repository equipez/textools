...
%% e-TeX tools for LaTeX. Some commands below need it, e.g., \pretocmd.
\usepackage{etoolbox}
...
Z. Zhang
\thanks{
School of Mathematics, Sun Yat-sen University, China. Email:~\email{zhangzaikun@mail.sysu.edu.cn}.
}
}
...
\begin{proof}
Equation~\eqref{eq:euler} implies that
\begin{equation*}
  \me^{\mi \pi} \;=\; -1,
\end{equation*}
