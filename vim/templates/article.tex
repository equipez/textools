...
% Bibliography
\newcommand{\bibfile}{!comp!expand("%:t:r")!comp!.bib}  % Name of the BibTeX file.
...
\usepackage{tikz,tikzscale,pgf,pgfarrows,pgfnodes,filecontents}
...
\usepackage{silence}
\WarningFilter{latex}{Empty `thebibliography' environment}  % Mute the warning about no bib entry is cited
